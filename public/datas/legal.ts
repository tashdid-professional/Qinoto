export const legalContent: Record<string, { title: string; content: string[] }> = {
  "privacy-policy": {
    ...
    content: [
      "Your privacy is important to us. It is Blush's policy to respect your privacy regarding any information we may collect from you across our website.",
  ...
  "terms-and-conditions": {
    ...
    content: [
      ...
      "Permission is granted to temporarily download one copy of the materials (information or software) on Blush's website for personal, non-commercial transitory viewing only.",
      ...
      "The materials on Blush's website are provided on an 'as is' basis. Blush makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.",
      "In no event shall Blush or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Blush's website.",
