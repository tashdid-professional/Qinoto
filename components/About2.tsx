...
export default function ColorsSection() {
  return (
    <section className="bg-white font-karla overflow-hidden mb-26">
      <div className="flex flex-col lg:flex-row items-stretch ">
        {/* Text Content Side (Left on Desktop) */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center  gap-8 order-2 lg:order-1 py-20 px-6 md:px-12 lg:px-24">
          {/* Zig-Zag Icon */}
        ...
        <div className="relative w-full lg:w-1/2 order-1 lg:order-2 min-h-[400px] lg:min-h-[600px]">
          <Image
            src={about2.image}
            alt="Color Shades"
            fill
