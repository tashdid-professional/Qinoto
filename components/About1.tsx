  ...
  return (
    <section className="bg-white pt-20 md:pt-32 font-karla overflow-hidden">
      <div className="flex flex-col lg:flex-row items-stretch">
        ...
        <div className="relative w-full lg:w-1/2 order-2 lg:order-1 min-h-[400px] lg:min-h-[600px]">
          <Image
            src={about1.image}
        ...
        {/* Text Content Side */}
        <div className="w-full lg:w-1/2 flex flex-col justify-center gap-8 order-1 lg:order-2 py-20 px-6 md:px-12 lg:px-24">
